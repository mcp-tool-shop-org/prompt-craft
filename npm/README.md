...
developed on. The core is GPU-free, deterministic, and covered by **325 passing tests**
(counted 2026-08-18). SDXL pose-lock, IP-Adapter, LoRA, InstantID, and regional inpaint are wired in code and
