...
|---|---|
| `0` | la porte d’entrée s’est exécutée et tous les éléments requis ont réussi |
| `1` | arguments incorrects ou contrat malformé |
| `2` | elle s’est exécutée, et un élément requis a **échoué** |
...
`main` est le seul état pris en charge. Pas de canal de publication, pas de politique de rétroportage, pas d’accord sur les niveaux de service (SLA). Il s’agit d’une infrastructure de studio publiée en open source, et non d’un produit avec un contrat de support.
